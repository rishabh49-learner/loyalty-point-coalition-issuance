	...
	<div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
		...
		>
			<span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3"
				>Welcome to the</span
			>
			<span class="text-sm font-medium">The Coalition Loyalty Point Issuance Page For Brands</span>
			<svg
				class="ml-2 w-5 h-5"
				fill="currentColor"
				viewBox="0 0 20 20"
		...
		<h1
			class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white pt-4"
		>
			Coalition Loyalty Point Issuance Page for Brands
		</h1>
		<p
			class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 pt-4"
		>
